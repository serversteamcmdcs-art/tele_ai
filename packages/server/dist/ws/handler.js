...
export function sendToChat(chatId, event, excludeUserId) {
...
async function handleClientEvent(userId, event, socket, app) {
    switch (event.type) {
        case 'ping':
...
async function handleEditMessage(userId, data) {
...
async function handleReadMessage(userId, data) {
...
async function handleReaction(userId, data) {
...
async function handleCallInitiate(userId, data) {
...
async function handleCallAction(userId, type, data) {
